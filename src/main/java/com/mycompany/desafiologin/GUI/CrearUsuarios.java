...
public class CrearUsuarios extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        //Obtenemos los valores ingresados en los textfields y los guardamos en una variable
        String nombre = txtNombre.getText();
        String password = txtPassword.getText();
        String nombreRol = (String)cmbRol.getSelectedItem();
        
        //Pasamos las variables obtenidas como parametros para nuestra funcion crearUsuario
        control.crearUsuario(nombre,password,nombreRol);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        //creamos una lista de roles con los roles existentes en la base de datos
        List<Rol> listaRoles = control.traerRoles();
        //Si existen rol (diferente a null) cargamos en el combo los roles de la lista.
        if(listaRoles!=null){
