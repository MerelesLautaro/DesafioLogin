...
public class PrincipalUser extends javax.swing.JFrame {
    ...
    public PrincipalUser(Controladora control, String usuario) {
        initComponents();
    ...
    private void cargarTabla() {
        ...
        String titulos[] = {"ID","Nombre","Rol","Descripcion"};
        ...
        if(listaUsuarios!=null){
            for (Usuario user : listaUsuarios){
                ...
                Object[] objeto = {user.getId(),user.getNombre(),user.getRol().getNombreRol(),user.getRol().getDescripcion()};
